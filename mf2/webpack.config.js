...
const config = {
  ...
  output: {
    ...
    uniqueName: 'mf2' // fix: important for module federation error - Cannot read properties of undefined (reading 'call')
// also ensure package.json name is mf2
  },
  mode: 'development',
  module: {
    rules: [
  ...
  plugins: [
    ...
    new MF({
      // exposes data from this repo: mf2
      name: 'mf2',
